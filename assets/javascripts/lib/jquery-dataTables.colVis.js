...
ColVis.prototype = {
	...
	"_fnDomRestoreButton": function ()
	{
		...
		$(nButton).click( function (e) {
            ...
            {
                that.s.dt.oInstance.fnSetColumnVis( i, that.s.abOriginal[(typeof that.s.dt.aoColumns[i]._ColReorder_iOrigCol != 'undefined' ? that.s.dt.aoColumns[i]._ColReorder_iOrigCol : i)
], false );
            }
